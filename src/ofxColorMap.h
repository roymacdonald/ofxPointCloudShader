...
public:
    ofxColorMapGui(){}
    ofxColorMapGui(ofxGuiGroup* gui, string name, ofxColorMap* colorMap);

    virtual ~ofxColorMapGui(){
    }

    void setup(ofxGuiGroup* gui,  string name, ofxColorMap* colorMap);
